...
export function LoginView({ onNavigate, onLogin }) {
    ...
    return (<div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-sidebar to-sidebar/90 items-center justify-center p-12">
        <div className="max-w-md text-center">
          <div className="w-24 h-24 mx-auto mb-8 rounded-2xl bg-gradient-to-br from-primary to-gold-400 shadow-gold flex items-center justify-center">
          ...
          <p className="text-sidebar-foreground/70">
            Join thousands of traders on the most trusted gold trading platform. 
            Secure escrow, verified merchants, and real-time market data.
          </p>
        </div>
      </div>
    </div>);
